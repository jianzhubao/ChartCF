"""
Prepare ECDBench dataset in SWIFT json format for inference

This script converts ECDBench data to SWIFT's expected format:
{
    "messages": [
...
def convert_to_swift_format(data, image_dir):
    """
    Convert ECDBench data to SWIFT format

    Args:
        data: List of ECDBench data items
...
def main():
    parser = argparse.ArgumentParser(description='Prepare ECDBench dataset for SWIFT inference')
    parser.add_argument('--input_file', type=str,
                        default='data/public_benchmarks/ECDBench/ECD_Bench_All.json',
                        help='Input data file')
    parser.add_argument('--image_dir', type=str,
                        default='data/public_benchmarks/ECDBench/rendered_images',
                        help='Directory containing images')
    parser.add_argument('--output_dir', type=str,
                        default='data/public_benchmarks/ECDBench/swift_data',
