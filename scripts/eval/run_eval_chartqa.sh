...
CHARTQA_DATA_PATH="data/public_benchmarks/ChartQA/test/test_data.json"
CHARTQA_IMAGE_DIR="data/public_benchmarks/ChartQA/test/png"
SWIFT_DATA_DIR="data/public_benchmarks/ChartQA/swift_data"
SWIFT_DATASET="${SWIFT_DATA_DIR}/test.json"
SAVE_NAME="${CHECKPOINT_DIR}/ChartQA"
...
python src/chartcf/evaluation/ChartQA/prepare_swift_dataset.py \
    --input_file "$CHARTQA_DATA_PATH" \
...
python src/chartcf/evaluation/ChartQA/convert_swift_results.py \
    --swift_output "$SWIFT_OUTPUT" \
    --dataset "$SWIFT_DATASET" \
    --output "$FINAL_OUTPUT"

python src/chartcf/evaluation/ChartQA/evaluate.py \
